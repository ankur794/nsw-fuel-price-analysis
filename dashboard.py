...
# Latest priced + located data (used by maps and finder)
...
# ================= 1. PRICE CYCLE ANALYSIS (the core) =================
st.header("1. The price cycle")
...
st.info(
    ...
    f"(tested separately) needs several full cycles before it overtakes the simple model."
)
...
# ================= 2. STATEWIDE PRICE MAP =================
st.header("2. Prices across NSW right now")
...
# ================= 3. FIND CHEAPEST NEAR YOU (applied tool) =================
st.header("3. Find the cheapest fuel near you")
if priced is not None:
